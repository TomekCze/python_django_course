...
def contact(request):
    if request.method == 'POST':
        ...
        user_contact = Contact(listing=listing, listing_id=listing_id, name=name, email=email, phone=phone,
        ...
        #     'kontoprojekt1231@gmail.com',
        #     [realtor_email, 'tomek.czernecki@gmail.com'],
        #     fail_silently=False
        # )
